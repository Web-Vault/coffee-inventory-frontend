              ...
              {activePage === 'replenishment' && (
                <>
                  <div style={{ padding: '14px 20px 6px' }}>
                    <div style={{ fontSize: '11px', color: 'var(--text3)', fontWeight: '600', marginBottom: '8px' }}>7-day demand forecast</div>
                    <div style={{ height: '350px', width: '100%', background: 'var(--card)', border: '1px solid var(--border)', borderRadius: '14px', padding: '20px' }}>
                      <DemandChart forecastData={dashboardData.forecast} />
                    </div>
                  </div>
                  <div className="table-wrap">
